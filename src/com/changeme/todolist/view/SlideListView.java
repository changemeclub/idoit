...
public class SlideListView extends ListView {
	...
	/**
	 * 分发事件，主要处理的是看是否是上下滑动还是左右滑动。如果是上下滑动则继续传递给子对象。如果是左右滑动，则进行跟踪。
	 */
	@Override
	...
	private void scrollRight() {
		...
		if(-itemView.getScrollX()<screenWidth*2/3){
			scroller.startScroll(itemView.getScrollX(), 0, -screenWidth*2/3, 0);
...
//				itemView.scrollBy(deltaX, 0);
	...
	private void unDoItemView(View itemView){
